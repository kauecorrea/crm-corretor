...
export function DeleteLeadButton({ id, onSuccess }: { id: string, onSuccess?: () => void }) {
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Tem certeza que deseja apagar este lead?</AlertDialogTitle>
          <AlertDialogDescription>
            Esta ação não pode ser desfeita e removerá este contato do seu funil de vendas.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
