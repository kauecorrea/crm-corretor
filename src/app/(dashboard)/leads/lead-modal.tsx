      ...
      <SheetContent className="w-full sm:max-w-lg overflow-y-auto">
        <SheetHeader className="mb-6">
          <div className="flex justify-between items-start">
            <div>
              <SheetTitle className="text-2xl">{client ? client.name : "Lead Sem Cliente"}</SheetTitle>
            ...
            <DeleteLeadButton id={lead.id} onSuccess={onClose} />
          </div>
        </SheetHeader>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-2 text-sm text-slate-600">
              ...
              {!client && (
                <p className="text-muted-foreground italic text-xs">Este lead não possui um cliente cadastrado vinculado a ele.</p>
              )}
              {lead.property && (
          ...
          <div className="space-y-3">
            ...
            {client ? (
              ...
              <p className="text-sm text-slate-500">Para adicionar lembretes, edite este lead e vincule-o a um cliente.</p>
            )}
          </div>
          ...
          <div className="space-y-3">
            ...
            {client ? (
              ...
              <p className="text-sm text-slate-500 text-center py-4">Para adicionar histórico de conversas, edite este lead e vincule-o a um cliente.</p>
            )}
          </div>
        </div>
      </SheetContent>
